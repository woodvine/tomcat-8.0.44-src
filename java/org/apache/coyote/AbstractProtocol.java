...
public abstract class AbstractProtocol<S> implements ProtocolHandler,
    ...
    protected abstract static class AbstractConnectionHandler<S,P extends Processor<S>>
        ...
        public SocketState process(SocketWrapper<S> wrapper,
                SocketStatus status) {
            System.out.println("process socket status :"+status);
            if (wrapper == null) {
            ...
            try {
                ...
                do {
                    if (dispatches != null) {
                        ...
                        System.out.println("请求需要转发，则缓存socket");
                        ...
                        System.out.println("status is OPEN_WRITE.");
                        // Extra write event likely after async, ignore
                        state = SocketState.LONG;
                    } else {
                        state = processor.process(wrapper);
                        System.out.println("after process ,the status is:"+state);
                    }
                    ...
                    if (state == SocketState.UPGRADING) {
                        System.out.println("after process ,the status is UPGRADING");
                ...
                System.out.println("outside while the state :"+state);
                if (state == SocketState.LONG) {
                    // In the middle of processing a request/response. Keep the
                    // socket associated with the processor. Exact requirements
                    // depend on type of long poll
                    System.out.println("after processor process the SocketState.LONG，则缓存socket");
                    connections.put(socket, processor);
                    ...
                    System.out.println("AbstractProtocol release addToPoller true");
                ...
                System.out.print("stat :"+state.toString());
                return state;
